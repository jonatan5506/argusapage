...
const FEATURES = [
  ...
  },
  {
    ...
    description: "Evoluímos para resolver problemas simples com rapidez e eficiência! 🚀",
  },
];
    ...
    <section className="py-28 px-8">
      <div className="container mx-auto grid grid-cols-1 place-items-center lg:grid-cols-3">
        ...
        <div className="col-span-2 lg:pl-24">
          ...
          >
            Resolvemos problemas de TI em tempo hábil, minimizando a interrupção das atividades.
          </Typography>
